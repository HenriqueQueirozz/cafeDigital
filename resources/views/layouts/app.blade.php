...
<html lang="pt-br">
    ...
    <body class="truncate"><!-- POSSIVELMENTE VAI DAR PROBLEMA -->
        ...
        <ul class="app-menu w-60 h-full lg:w-30 bg-primary-400 text-mainInputColor text-base flex flex-col text-center">
