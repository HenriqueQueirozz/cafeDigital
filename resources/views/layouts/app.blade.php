...
<html lang="pt-br">
    ...
    <body class="truncate"><!-- POSSIVELMENTE VAI DAR PROBLEMA -->
        ...
        <div class="flex">
            <img src="{{ asset('src/perfil/'.session('nomeFoto_fp')) }}" onclick="MudarEstadoImagem('app-modal-opcoes')" class="fixed top-0 left-100 right-0 m-5 w-20 border-solid border-4 rounded-full border-secondary-500 cursor-pointer" id="perfilImagem">
